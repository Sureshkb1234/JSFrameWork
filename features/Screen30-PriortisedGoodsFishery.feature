@no
Feature: Screen level validations for Is the vehicle carrying exclusively live and or fresh seafood products
...
Scenario Outline:  User is in home page screen with live animals when departing from Great Britain, navigates to Is the vehicle carrying exclusively live and or fresh seafood products
    ...
    And I click Continue button
	And I select the response as "Yes" as user is displayed with the question Do you have catch certificate
	And I click Continue button
    ...
    And I click Continue button
    And I select the response as "<Response>" as user is displayed with the question Is the vehicle carrying exclusively live and or fresh seafood products
	And I click Continue button
...
Examples:
	...
	| No option to be selected | Select yes if the vehicle carrying exclusively live and/or fresh seafood products |